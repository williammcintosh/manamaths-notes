...
\begin{tikzpicture}[x=0.55cm,y=0.55cm,line cap=round,line join=round]
  \fill[mmgreenLeaf!15] (0,0) -- (2,0) -- (2,1.35) -- (0,1.35) -- cycle;
  \fill[mmgreenLeaf!25] (2,0) -- (2.45,0.22) -- (2.45,1.57) -- (2,1.35) -- cycle;
  \fill[mmgreenLeaf!10] (0,1.35) -- (2,1.35) -- (2.45,1.57) -- (0.45,1.57) -- cycle;
  \draw (2,0) -- (2,1.35) -- (0,1.35) -- (0,0) -- (2,0);
  \draw (2,1.35) -- (2.45,1.57);
  \draw (0,1.35) -- (0.45,1.57) -- (2.45,1.57) -- (2.45,0.22) -- (2,0);
  \draw[densely dashed] (0,0) -- (0.45,0.22) -- (2.45,0.22);
  \draw[densely dashed] (0.45,0.22) -- (0.45,1.57);
  \draw[<->,thin] (0.45,-0.28) -- (2.45,-0.28) node[midway,below,font=\tiny]{#2};
  \draw[<->,thin] (-0.32,0) -- (-0.32,1.35) node[midway,left,font=\tiny]{#3};
\end{tikzpicture}%
